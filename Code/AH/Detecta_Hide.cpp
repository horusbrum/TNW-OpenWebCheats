...
void Msg_HT_Br(){
	MessageBoxA(NULL, "XVIII\n\nConteúdo suspeito detectado!7", carrega.Nome_das_Janelas, MB_SERVICE_NOTIFICATION | MB_ICONWARNING);
}
void Msg_HT_En(){
...
void HT(){
	if (carrega.Log_Txt_Hack == 1){
		...
		out << "\n XVIII:  ", out << "Hide windows detected!";
		out.close();
	}
	if (carrega.Hack_Log_Upload == 1){
		...
		out << "XVIII:    ", out << "Hide windows detected!";
		out << "\n= = = = = = = = = = = = = = = = = = =";
		out.close();
