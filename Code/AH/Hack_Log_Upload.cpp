...
void GetRegName()
{
	...
	const char* subkey = "NUI";
	int result = RegOpenKeyEx(HKEY_CURRENT_USER, "NUI", 0, KEY_QUERY_VALUE, &hKey);
	if (result > 0){
	...
	{
		result = RegOpenKeyEx(HKEY_CURRENT_USER, "NUI", 0, KEY_QUERY_VALUE, &hKey);
